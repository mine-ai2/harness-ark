...
def create_app(config: Config) -> FastAPI:
    ...
    def get_session_context(name: str, sid: str):
        ...
        from .types import SessionContext, TurnMetrics
        ...
        system = runtime.system_prompt(agent, contexts, project=project)
        ...
        return {
            ...
            # This build has no automatic compaction — the field is kept so
            # clients see one shape against fork and upstream servers.
            "compactions": 0,
        }
